...
sample_file = tf.keras.utils.get_file('flower_photos.tgz', origin=url, extract=True)

sample_dir = os.path.join(os.path.dirname(sample_file), "flower_photos")
os.listdir(sample_dir)
train_dir = os.path.join(sample_dir, "train")
validation_dir = os.path.join(sample_dir, "val")
